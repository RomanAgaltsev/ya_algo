...
Иницицализация дека
Чтение команд всех команд с входа - но в одном цикле с выполнением
Выполнение всех команд с входа - но в одном цикле с чтением
Выполнение одной команды с входа

-- ПРОСТРАНСТВЕННАЯ СЛОЖНОСТЬ --
Для оценки пространственной сложности, за n принимаем количество команд на входе и за m максимальное количество значений в деке.

Дек - буфер+голова+хвост+макс+размер
Команда - строка+целое число
При чтении с входа commandsNumber, dequeMax, слайс команды и команда
При операциях с деком, переменная value
