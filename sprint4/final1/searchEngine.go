...
func (s *SearchEngine) processQuery(query string) []int {
	...
	// Сортируем слайс сортировкой стандартной библиотеки, но с использованием собственного компаратора
	slices.SortFunc(wordsCountSorted, func(a, b [2]int) int {
	...
	for i := 0; i < s.limit && i < len(wordsCountSorted); i++ {
